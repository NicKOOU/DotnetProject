...
namespace LibraryApp.DataAccess
{
        ...
        where DBEntity : class, new()
    {
        ...
        protected LibraryAppContext _context;
        protected ILogger _logger;
        protected readonly IMapper _mapper;

        public Repository(LibraryAppContext context, ILogger logger, IMapper mapper)
        {
            _context = context;
            _logger = logger;
            _mapper = mapper;
        ...
        {
            DBEntity dbEntity = _set.Find(keyValues: idEntity);
